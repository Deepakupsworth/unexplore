                                                    ...
                                                    <div
                                                        ...
                                                        <div class="accordion-header">
                                                            <div
                                                                ...
                                                                <div class="vertical-divider d-none-md"></div>
                                                                <p class="p-small d-none-md">New Delhi to Riyadh</p>
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="accordion-header">
                                                            <div
                                                                ...
                                                                <div class="vertical-divider d-none-md"></div>
                                                                <p class="p-small d-none-md">Airport to hotel in
                                                                    Riyadh</p>
                                                            </div>
                                                            <div
                                                                class="d-flex gap-2 pkg-details__accordion-actions">
                                                        ...
                                                        <div id="transferCollapse"
                                                            ...
                                                            <div class="accordion-body">
                                                                <div class="d-flex align-items-center gap-3">
                                                                    <img src="../assets/transfer.png" alt="Transfer"
            ...
            <div class="pkg-details__pricing">
                <div class="card pkg-details__pricing-card">
                    ...
                    <div class="d-flex align-items-center gap-1">
                        <img src="../assets/icons/riyal-light.svg" alt="Riyal">
                        <p class="text-decoration-line-through fw-600 text-light2">60,000</p>
                    </div>

                    <div class="d-flex align-items-center gap-1">
                        <img src="../assets/icons/riyal-primary.svg" alt="Riyal">
                    ...
                    <div class="pkg-details__decorative-line my-3">
                        <img src="../assets/decorative-line.png" alt="Decorative Line" class="img-fluid w-100">
                    </div>
