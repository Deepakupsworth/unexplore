                                    ...
                                    <div class="pkg-details__additional-info mt-3">
                                        ...
                                        @foreach ($package->infos as $info)
                                            ...
                                            <div class="pkg-details__additional-info-item">
                                                <p class="fw-bold pkg-details__additional-info-item-header">{{$info->translation->title}}</p>
                ...
                <div class="pkg-details__pricing mt-4">
                    <div class="card pkg-details__pricing-card">
                        ...
                        <div class="d-flex align-items-center gap-1">
                            ...
                            <p class="text-decoration-line-through fw-600 text-light2">{{$package->price->discount_price}}</p>
                        </div>
                        @endif
                        ...
                        <div class="pkg-details__additional-info-item py-2 px-3 d-flex align-items-center gap-2 mb-2">
                            ...
                            <div class="">
                                ...
                                <p class="fw-600 p-large">{{$package->duration_nights}} Nights & {{$package->duration_days}} Days</p>
                            </div>
                        </div>
            ...
            <div class="container">
                ...
                <div class="gallery-sticky-header pt-4">
                    ...
                    <ul class="nav nav-tabs gallery-tabs" id="galleryTabs" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" data-target="galleryTabsProperty" type="button" role="tab">
                                Property Photos
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" data-target="galleryTabsActivities" type="button" role="tab">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" data-target="galleryTabsHighlights" type="button" role="tab">
                                Package Highlights
                        ...
                        <div class="gallery-modal-section" data-section="port-blair">
                            ...
                            <div class="gallery-image-grid">
                                <div class="gallery-img-box">
                                    <img class="img-fluid" src="{{ asset('frontend/assets/attraction-1.png')}}" alt="">
                                </div>
                                <div class="gallery-img-box">
                                    <img class="img-fluid" src="{{ asset('frontend/assets/attraction-1.png')}}" alt="">
                                </div>
