          ...
          <div class="col-md-12 col-lg-7">
            <div class="row footer-links-section">
              ...
              <div class="col-md-4 mb-4">
                ...
                <ul class="list-unstyled">
                  <li><a href="#" class="footer-link">{{ __('footer.link.terms_conditions') }}</a></li>
                  <li><a href="#" class="footer-link">{{ __('footer.link.privacy_policy') }}</a></li>
                  <li><a href="#" class="footer-link">{{ __('footer.link.faqs') }}</a></li>
                  <li><a href="#" class="footer-link">{{ __('footer.link.news_events') }}</a></li>
                  <li><a href="#" class="footer-link">{{ __('footer.link.cookie_policy') }}</a></li>
                </ul>
              </div>
              ...
              <div class="col-md-4 mb-4">
                ...
                <ul class="list-unstyled">
                  <li><a href="{{ asset('/about-us') }}" class="footer-link">{{ __('footer.link.about_us') }}</a></li>
                  <li><a href="{{ asset('/contact-us') }}" class="footer-link">{{ __('footer.link.contact_us') }}</a></li>
