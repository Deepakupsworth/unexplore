		...
		<div class="desktop-nav w-100">
			<nav class="collapse navbar-collapse justify-content-between" id="navbarNav">
				<ul class="navbar-nav mx-auto">
					...
					<li class="nav-item dropdown">
						<a class="nav-link" href="#" id="dealsDropdown" role="button" data-bs-toggle="dropdown"
							aria-expanded="false">
					...
					<li class="nav-item dropdown">
						<a class="nav-link" href="#" id="calendarDropdown" role="button" data-bs-toggle="dropdown"
							aria-expanded="false">
			...
			<nav class="collapse navbar-collapse justify-content-between" id="navbarNav">
				<div class="mx-3">
					<div class="accordion" id="navbarAccordion">
						...
						<div class="accordion-item mt-3">
							<button href="#" class="accordion-button collapsed" data-bs-toggle="collapse"
								data-bs-target="#collapseNavFour" aria-expanded="true" aria-controls="collapseNavFour">
								Deals & Offers
							</button>
						...
						<div class="accordion-item mt-3">
							<button href="#" class="accordion-button collapsed" data-bs-toggle="collapse"
								data-bs-target="#collapseNavFive" aria-expanded="true" aria-controls="collapseNavFive">
								Saudi Calendar
							</button>
