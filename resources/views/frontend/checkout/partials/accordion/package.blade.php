                            ...
                            <div class="tab-content">
                                ...
                                @foreach ($package->days as $day)
                                    <div class="tab-pane fade {{ $loop->first ? 'show active' : '' }}"
                                        ...
                                        {{-- Day Header --}}
                                        <div class="pkg-details__day-plan-header pkg-details__common-block">
                                            <p class="badge primary-bg">Day {{ $day->day_number }}
                                            </p>
                                            <p class="fw-600">
                                         ...
                                         >
                                                                ...
                                                                @foreach ($hotels as $index => $hotel)
                                                                    @php
                                                                        $hotelImage = $hotel?->thumb
                                                                            ? asset(
                                                                                'storage/' . $hotel->thumb->image_path,
                                                                            )
                                                                            : asset(
                                            ...
                                            @php
                                                ...
                                                $transports = $sessionTransportIds
                                                    ? $allTransports->whereIn('id', $sessionTransportIds)
                                                    : $day->items->where('item_type', 'transport')->map->transport;
                                            @endphp
