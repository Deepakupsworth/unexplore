        ...
        <div class="bg-white rounded-xl shadow p-6 space-y-10">
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input id="duration_days" type="number" class="form-control" name="duration_days"
                        value="{{ old('duration_days', $package->duration_days) }}">
                </div>

                <div>
                    <label class="form-label">Duration Nights *</label>
                    <input id="duration_nights" type="number" class="form-control" name="duration_nights"
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="date" class="form-control" name="availability[booking_start_date]"
