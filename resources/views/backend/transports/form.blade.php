        ...
        <div class="page-content">
            <div class="container-fluid">
                ...
                <div class="mb-6 flex justify-between items-center">
                    <h4 class="text-xl font-semibold">{{ $model->id ? 'Edit Transport' : 'Add Transport' }}</h4>
                                    ...
                                    <div class="grid grid-cols-2 gap-4">
                                        ...
                                        <div>
                                            ...
                                            <select name="type" class="form-control">
                                                @foreach (['taxi', 'car', 'bus', 'train', 'flight'] as $t)
                                                    <option value="{{ $t }}"
                                                        {{ old('type', $model->type) == $t ? 'selected' : '' }}>
                                                        {{ ucfirst($t) }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                        ...
                        <div class="col-span-4">
                            <div class="card p-4">
                                <div class="card-body space-y-6">
                                    ...
                                    <h5 class="font-semibold text-slate-700 border-b pb-2">Media</h5>
    ...
    <script>
        document.querySelectorAll('.lang-btn').forEach(btn => {
            btn.onclick = () => {
                ...
                document.querySelectorAll('.lang-section').forEach(s => {
