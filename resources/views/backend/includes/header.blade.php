 <!-- BEGIN: Header -->
        ...
        <div class="z-[9]" id="app_header">
          <div
              ...
              <div class="items-center space-x-4 rtl:space-x-reverse horizental-box">
                <a href="{{ url('/') }}">
                  <span class="xl:inline-block hidden">
                    <img src="/backend/images/logo/logo.svg" class="black_logo " alt="logo">
                    <img src="/backend/images/logo/logo-white.svg" class="white_logo" alt="logo">
                  </span>
            ...
            rounded-full text-[20px] flex flex-col items-center justify-center">
                ...
                <!-- Mail Dropdown -->
                {{-- @include('backend.includes.message_sec') --}}
      ...
      inline-flex items-center" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                    <div class="lg:h-8 lg:w-8 h-7 w-7 rounded-full flex-1 ltr:mr-[10px] rtl:ml-[10px]">
                      <img src="/backend/images/all-img/user.png" alt="user"
                        class="block w-full h-full object-cover rounded-full">
                    </div>
                    <span
                      class="flex-none text-slate-600 dark:text-white text-sm font-normal items-center lg:flex hidden overflow-hidden text-ellipsis whitespace-nowrap">{{ Auth()?->user()->first_name }}
                      </span>
                    <svg
      ...
      overflow-hidden">
            ...
            dark:text-white font-normal">
                      ...
                      <li>
                        <a href="{{ asset('/admin/profile') }}" class="block px-4 py-2 hover:bg-slate-100 dark:hover:bg-slate-600 dark:hover:text-white font-inter text-sm text-slate-600
            dark:text-white font-normal">
            ...
            dark:text-white font-normal">
                      ...
                      <li>
                        <div  class="block px-4 py-2 hover:bg-slate-100 dark:hover:bg-slate-600 dark:hover:text-white font-inter text-sm text-slate-600
            dark:text-white font-normal">
                          ...
                          <form method="POST" action="{{ route('logout') }}">
                            ...
                            class="relative top-[2px] text-lg ltr:mr-1 rtl:ml-1"></iconify-icon>
                            <button type="submit">  <span class="font-Inter">Logout</span></button>
                        </form>
