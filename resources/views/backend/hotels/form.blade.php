                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="text" name="location" value="{{ old('location', $model->location) }}"
                                    class="form-control" placeholder="Hotel address or area">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="email" name="email" value="{{ old('email', $model->email) }}"
                                    class="form-control" placeholder="hotel@example.com">
                            </div>
                        ...
                        @foreach ($languages as $lang)
                            ...
                            <div class="lang-section {{ $loop->first ? 'block' : 'hidden' }}"
                                ...
                                <div class="mt-4">
                                    ...
                                    <input class="form-control @error("translations.$code.name") border-red-500 @enderror"
